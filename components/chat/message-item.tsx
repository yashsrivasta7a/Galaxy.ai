...
export default function MessageItem({ role, content, parts, isLast, regenerate }: MessageItemProps) {
    ...
    return (
        <div className="w-full px-4 py-6 md:px-5 focus-visible:outline-0">
            <div className="max-w-3xl mx-auto flex gap-4 md:gap-6">

                <div className={cn("relative flex-1 overflow-hidden", isUser ? "flex justify-end" : "")}>
                    {isUser ? (
                        <div className="bg-[#2f2f2f] text-primary px-3.5 py-1 rounded-2xl max-w-[85%] whitespace-pre-wrap leading-7">
                            {textContent}
                        </div>
                    ) : (
